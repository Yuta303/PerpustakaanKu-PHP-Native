...
$sql = "SELECT * FROM db_anggota LIMIT $start, $limit";
$stmt = $pdo->query($sql);
...
$total_sql = "SELECT COUNT(*) FROM db_anggota";
...
<head>
    ...
    <title>Perpustakaan Ku - Laporan Data Anggota</title>
            ...
            <ul class="sidebar-nav">
                ...
                <li class="sidebar-item">
                    ...
                    <ul id="laporan" class="sidebar-dropdown list-unstyled collapse" data-bs-parent="#sidebar">
                        <li class="sidebar-item">
                            <a href="lap_anggota.php" class="sidebar-link">Lap. Data Anggota</a>
                        </li>
                        <li class="sidebar-item">
                            <a href="lap_buku.php" class="sidebar-link">Lap. Data Buku</a>
                        </li>
                    </ul>
                </li>
            </ul>
                        ...
                        <tbody>
                            <?php if (!empty($anggota)): ?>
                                <?php foreach ($anggota as $item): ?>
                                    <tr>
                                        <td><?php echo htmlspecialchars($item['id_anggota']); ?></td>
                                        ...
                                        <td><?php echo htmlspecialchars($item['nomor_telepon']); ?></td>
                                        <td><?php echo htmlspecialchars($item['email']); ?></td>
                                        <td><?php echo htmlspecialchars($item['tanggal_daftar']); ?></td>
                                    </tr>
                                <?php endforeach; ?>
                            <?php else: ?>
                                <tr>
